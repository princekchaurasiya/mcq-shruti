...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-end" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-success text-white">Teacher Panel</div>
            <div class="list-group list-group-flush">
                ...
                <a href="{{ route('mcq-tests.index') }}" class="list-group-item list-group-item-action {{ request()->routeIs('mcq-tests.*') ? 'active' : '' }}">
                    <i class="bi bi-file-text me-2"></i> MCQ Tests
                </a>
                <a href="{{ route('questions.index') }}" class="list-group-item list-group-item-action {{ request()->routeIs('questions.*') ? 'active' : '' }}">
                    <i class="bi bi-question-circle me-2"></i> Questions
                </a>
                <a href="{{ route('results.index') }}" class="list-group-item list-group-item-action {{ request()->routeIs('results.*') ? 'active' : '' }}">
