...
<head>
    ...
    <title>{{ config('app.name', 'MCQ Management') }} - Student Panel</title>
...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-end" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-info text-white">Student Panel</div>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                <div class="container-fluid">
                    <button class="btn btn-info text-white" id="sidebarToggle">Toggle Menu</button>
